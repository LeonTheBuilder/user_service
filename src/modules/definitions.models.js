const UserCodeMessages = Object.freeze({
    ...
    username_dup: {code: 'username_dup', message: 'username_dup'},
    password_repeat_no_match: {code: 'password_repeat_no_match', message: 'password_repeat_no_match'},
    login_fail: {code: 'login_fail', message: 'login_fail'},
});
